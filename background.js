import { saveURL, getProject, getProjectList, getProjectstructure, createNode, createEdge } from "./lib/backendApi.js";
...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
  ...
  (async () => {
    ...
    if (text && llmApiURL && llmApiKey && type === "gemini") {
      ...
      const { projectId, fromNodeId, toNodeId } = request;
      await createEdge(projectId, fromNodeId, toNodeId, sendResponse);
    } else {
